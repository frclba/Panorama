...
func (mr *MockUserReaderMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserWriterMockRecorder) Save(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockUserPersistenceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Save indicates an expected call of Save.
func (mr *MockUserPersistenceInterfaceMockRecorder) Save(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserServiceInterfaceMockRecorder) Create(name, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Disable indicates an expected call of Disable.
func (mr *MockUserServiceInterfaceMockRecorder) Disable(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Enable indicates an expected call of Enable.
func (mr *MockUserServiceInterfaceMockRecorder) Enable(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockUserServiceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
